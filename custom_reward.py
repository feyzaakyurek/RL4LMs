...
class EditMatch(RewardFunction):
    ...
    def __call__(self, prev_observation: Observation,
        ...
        if done:
            ...
            # Prepend prompt.
            input_wfeed = self.prompt + self.separator + prompt_or_input_text + "\nFeedback:" + feedback_pred + "\nEdit:"
            ...
            edit_pred = edit_pred[0].strip() # Strip whitespace.
            

            # Reward
            edit_gold = current_observation.target_or_reference_texts[0] # todo train file should have edit as target.
